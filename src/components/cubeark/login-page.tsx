    ...
    <div className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-br from-zinc-50 to-zinc-100">
      <div className="w-full max-w-sm mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Cubeark API Dynamic</h1>
          <a href="https://cubeark.dev" target="_blank" rel="noopener noreferrer" className="text-sm text-purple-500 hover:text-purple-600 mt-1 transition-colors">
            cubeark.dev
          </a>
        </div>
