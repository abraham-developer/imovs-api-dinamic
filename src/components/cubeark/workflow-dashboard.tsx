    ...
    <div className="h-screen w-screen flex flex-col bg-background">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b bg-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-foreground">Cubeark API Dynamic</h1>
            <a href="https://cubeark.dev" target="_blank" rel="noopener noreferrer" className="text-xs text-purple-500 hover:text-purple-600 -mt-0.5 transition-colors">
              cubeark.dev
            </a>
          </div>
        </div>
